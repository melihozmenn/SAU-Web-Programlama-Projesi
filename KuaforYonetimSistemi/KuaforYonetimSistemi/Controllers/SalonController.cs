...
namespace KuaforYonetimSistemi.Controllers
{
    public class SalonController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Adi,Adres,CalismaSaatleri")] Salon salon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Adi,Adres,CalismaSaatleri")] Salon salon)
        {
            if (id != salon.Id)
            {
                return NotFound();
