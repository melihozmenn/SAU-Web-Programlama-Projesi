    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Islems",
                columns: new[] { "Id", "Adi", "Sure", "Ucret" },
                values: new object[,]
                {
                    { 1, "Saç Kesimi", 30, 100.00m },
                    { 2, "Saç Boyama", 45, 150.00m },
                    { 3, "Saç Şekillendirme", 60, 200.00m },
                    { 4, "Manikür ve Pedikür", 60, 300.00m },
                    { 5, "Tıraş", 60, 100.00m },
                    { 6, "Saç Bakımı", 60, 500.00m }
                });
